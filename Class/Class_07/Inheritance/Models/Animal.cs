namespace Inheritance.Models
{
    public class Animal
    {
        ...
        //The Protected properties are only accessible in the class (Animal) and in the inherited classes(not in Program.cs)
        ...
        {
            Console.WriteLine($"The animal Id {Id} and Name {Name} is {Age} years old.");
        }
